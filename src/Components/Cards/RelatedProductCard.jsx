...
export default function RelatedProductCard({ item }) {
    ...
    useEffect(() => {
          ...
          const addWishlist = (id) => {
                ...
                setCurrentItem((prev) => ({ ...prev, is_wishlisted: true }));
            };
             ...
             const removeWishlist = (id) => {
                ...
                setCurrentItem((prev) => ({ ...prev, is_wishlisted: false }));
            };
            ...
            <div
               ...
               <div className="absolute right-4 top-4 z-20 cursor-pointer">
                        {currentItem?.is_wishlisted ?
                            <svg onClick={(e) => { e.stopPropagation(); setWishlist(false); removeWishlist(currentItem.id) }} className="rounded-full p-[2px] shadow-md transition-transform duration-300 ease-in-out hover:scale-125" xmlns="http://www.w3.org/2000/svg" width="24px" height="24px" viewBox="0 0 24 24" >
                            ...
                            :
                            <svg onClick={(e) => { e.stopPropagation(); setWishlist(true); addWishlist(currentItem.id) }} className="bg-white rounded-full p-[4px] shadow-md transition-transform duration-300 ease-in-out hover:scale-125" xmlns="http://www.w3.org/2000/svg" width="26px" height="26px" viewBox="0 0 24 24" >
                ...
                <div className="w-full h-[88.37px] relative">
                    <h1 className="text-[16.85px] font-bold bolkit text-[#474141] truncate">{currentItem?.head}</h1>
                    <div className="md:text-[10px] text-[9px] leading-[13.48px] text-[#474141B2] instrument-san">{currentItem.description
                        ? isExpanded
                            ? currentItem.description
                            : currentItem.description.slice(0, 100)
                        ...
                        <div className="w-fit flex">
                            ...
                            {starArray.map((count) => {
                                ...
                                if (count <= currentItem.average_rating) {
                                    return (
                                        <>
                        ...
                        <h1 className="text-[15.43px] font-bold robo text-[#56433D]">₹ {currentItem.grand_total}</h1>
