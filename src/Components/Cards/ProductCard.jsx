    ...
    return (
        <>
            <div
                ...
                className="relative md:max-w-[302px] overflow-hidden max-w-[180px] cursor-pointer h-auto rounded-[3%] md:py-[3%] md:px-[4%] px[1%] flex flex-col md:gap-[2%] p-1 border-[0.5px] border-[#C8983E] items-center ">
                ...
                <div className="md:w-full md:h-[200px] h-[108px] w-full flex justify-center relative">
                    <div className="absolute right-4 top-3 z-20 cursor-pointer">
                        {currentItem?.is_wishlisted ?
                            ...
                            :
                            <svg onClick={(e) => { e.stopPropagation(); addWishlist(currentItem.id) }} className="rounded-full p-[2px] shadow-md transition-transform duration-300 ease-in-out hover:scale-125" xmlns="http://www.w3.org/2000/svg" width="24px" height="24px" viewBox="0 0 24 24" >
